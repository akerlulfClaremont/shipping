			...
			onTheMasterPage : {
							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("TenderAgentSet", {
											Tknum : sCurrentId
										});
				...
				assertions : {
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("TndrActp");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all TenderAgentSet to be able to check for the total amount
