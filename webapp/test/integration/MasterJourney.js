sap.ui.define([
		...
		opaTest("MasterList Filtering on TndrActp less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<TndrActp>").
				and.iSelectListItemInViewSettingsDialog("<100 <TndrActc>").
		...
		opaTest("MasterList Filtering on TndrActp more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <TndrActc>").
				and.iPressOKInViewSelectionDialog();
