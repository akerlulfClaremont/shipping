...
sap.ui.define([
	...
	"com/tender/agent/model/grouper",
	...
	"use strict";
	return BaseController.extend("com.tender.agent.controller.Master", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.tender.agent.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function(oEvent) {
			...
			aFilterItems.forEach(function(oItem) {
				switch (oItem.getKey()) {
					case "Filter1":
						aFilters.push(new Filter("TndrActp", FilterOperator.LE, 100));
						break;
					case "Filter2":
						aFilters.push(new Filter("TndrActp", FilterOperator.GT, 100));
						break;
					default:
						break;
				}
		...
		_updateFilterBar: function(sFilterBarText) {
			...
			/**
			 *@memberOf com.tender.agent.controller.Master
			 */
	});
});