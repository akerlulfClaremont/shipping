sap.ui.define([
		...
		return BaseObject.extend("com.tender.agent.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.tender.agent.model.ListSelector
			 */
			 ...
			 * @return {com.tender.agent.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
